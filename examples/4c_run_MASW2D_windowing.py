...
#swam.extract_curves(apply_to = 'all', pck_mode='auto', auto_method = 'max', trafo_method = 'fdbf', use_windows=True)

# swam.extract_curves(apply_to = 'all', pck_mode='auto', auto_method = 'MOPA', use_windows=True, stopAtChi2 = 1, rel_err = 15/100)
# #
# # plot the pseudosection
#swam.plot_pseusodsection(auto_method = 'MOPA', trafo_method = None, cmap='cividis')
fig,ax = plt.subplots(figsize=(6,2))
swam.plot_pseusodsection(procset = procset, auto_method = 'max', trafo_method = 'fdbf', cmap='cividis', axes = ax,
                         outfile = '/home/Natalie/Documents/Projects/GIT/swa/data/syn_data/figures_EGU/Pseudosections/pseudo_masw2d_v2.png')

# fig,ax = plt.subplots(figsize=(6,2))
# swam.plot_pseusodsection(auto_method = 'MOPA', trafo_method = None, cmap='cividis', axes = ax,
#                          outfile = '/home/Natalie/Documents/Projects/GIT/swa/data/syn_data/figures_EGU/Pseudosections/pseudo_mopa_v2.png')
