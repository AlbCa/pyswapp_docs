...
new_procset = 'new'
swam.process_curves(apply_to = 'cur', procset= new_procset,attr='smooth',
...
swam.load_procset(procset)
swam.process_curves(apply_to = 'cur',attr='estimate_error', method='MOPA', procset= 'new5', **processing_kwargs)
